...
public class UIBase : MonoBehaviour, TUIHandler
{
	private TUI m_tui;
	...
	{
		if (control.name == "Suitup" && eventType == 3)
		{
			SwitchScene("SuitUp");
			DataCenter.StateCommon().audio.GetComponent<TAudioController>().PlayAudio("UI_MeuButton_Click");
		}
		else if (control.name == "Medals" && eventType == 3)
		{
			SwitchScene("Medals");
			DataCenter.StateCommon().audio.GetComponent<TAudioController>().PlayAudio("UI_MeuButton_Click");
		}
		else if (control.name == "Score" && eventType == 3)
		{
			SwitchScene("Score");
			DataCenter.StateCommon().audio.GetComponent<TAudioController>().PlayAudio("UI_MeuButton_Click");
		}
	...
	{
		UtilUIUpdateAttribute.SetLastScene("Base");
