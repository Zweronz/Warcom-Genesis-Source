...
public class UtilUIShopWeapons : MonoBehaviour
{
	...
	public void Start()
	{
		...
		int weaponCount = DataCenter.Conf().GetWeaponCount(type);
		for (int i = 0; i < weaponCount; i++)
		{
			WeaponInfo weaponInfo = DataCenter.Conf().GetWeaponInfo(type, i);
