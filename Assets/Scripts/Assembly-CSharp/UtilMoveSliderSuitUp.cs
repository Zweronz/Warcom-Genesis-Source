...
public class UtilMoveSliderSuitUp : MonoBehaviour
{
	public UISuitUp m_suitUp;
	...
	private void OnButtonSliderEndDelegate(TUIInput input)
	{
		...
		if (component.IsSelected() && component.PtInControl(input.position))
		{
			if (m_weaponInfo != null)
			{
				...
				{
					DataCenter.Save().EquipWeapon(m_suitUp.m_charactorIndex, m_weaponInfo.name);
				}
				else
				{
					DataCenter.Save().EquipWeaponInPos(m_suitUp.m_charactorIndex, m_weaponInfo.name, 1);
				}
		...
		else if (component2.IsSelected() && component2.PtInControl(input.position))
		{
			if (m_weaponInfo != null)
			{
				...
				{
					DataCenter.Save().EquipWeaponInPos(m_suitUp.m_charactorIndex, m_weaponInfo.name, 2);
				}
				DataCenter.StateCommon().audio.GetComponent<TAudioController>().PlayAudio("UI_Gun_DrawDown");
			}
		}
		else if (component3.IsSelected() && component3.PtInControl(input.position))
		{
			if (m_weaponInfo != null)
			{
				...
				{
					DataCenter.Save().EquipWeaponInPos(m_suitUp.m_charactorIndex, m_weaponInfo.name, 3);
				}
		...
		else if (component4.IsSelected() && component4.PtInControl(input.position))
		{
			if (m_armorInfo != null)
			{
				DataCenter.Save().EquipArmorInPos(m_suitUp.m_charactorIndex, m_armorInfo.name, 1);
			}
		...
		else if (component5.IsSelected() && component5.PtInControl(input.position))
		{
			if (m_armorInfo != null)
			{
				DataCenter.Save().EquipArmorInPos(m_suitUp.m_charactorIndex, m_armorInfo.name, 2);
			}
			DataCenter.StateCommon().audio.GetComponent<TAudioController>().PlayAudio("UI_Ammor_DrawDown");
		}
		else if (component6.IsSelected() && component6.PtInControl(input.position))
		{
			if (m_armorInfo != null)
			{
				DataCenter.Save().EquipArmorInPos(m_suitUp.m_charactorIndex, m_armorInfo.name, 3);
			}
			DataCenter.StateCommon().audio.GetComponent<TAudioController>().PlayAudio("UI_Ammor_DrawDown");
		}
		else if (component7.IsSelected() && component7.PtInControl(input.position))
		{
			if (m_itemInfo != null)
			{
				DataCenter.Save().EquipItemInPos(m_suitUp.m_charactorIndex, m_itemInfo.name, 1);
			}
		...
		else if (component8.IsSelected() && component8.PtInControl(input.position))
		{
			if (m_itemInfo != null)
			{
				DataCenter.Save().EquipItemInPos(m_suitUp.m_charactorIndex, m_itemInfo.name, 2);
			}
			DataCenter.StateCommon().audio.GetComponent<TAudioController>().PlayAudio("UI_Items_DrawDown");
		}
		else if (component9.IsSelected() && component9.PtInControl(input.position))
		{
			if (m_itemInfo != null)
			{
				DataCenter.Save().EquipItemInPos(m_suitUp.m_charactorIndex, m_itemInfo.name, 3);
			}
			DataCenter.StateCommon().audio.GetComponent<TAudioController>().PlayAudio("UI_Items_DrawDown");
		}
		DataCenter.Save().Save();
		m_suitUp.RefreshCharacterEquipInfo(m_suitUp.m_charactorIndex);
