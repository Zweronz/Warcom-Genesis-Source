...
public class Utils
{
	...
	public static void ShowIndicatorSystem_int(int style, Vector2 loc, float r, float g, float b, float a)
	{
	}
	...
	public static Vector2 ScreenCenter()
	{
		...
		{
			result = new Vector2(512f, 384f);
		}
		else if (Screen.width > 1024 && Screen.width <= 1136)
		{
			result = new Vector2(284f, 384f);
		}
